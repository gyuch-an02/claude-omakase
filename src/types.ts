...
export interface Entry {
  ...
  version?: string;
  license?: string;
  // Upstream popularity signal (e.g. GitHub stars of the source repo). Used only
  // as a ranking PRIOR/tiebreaker in search — never enough to outrank a keyword
  // match. Optional; many sources don't expose it.
  stars?: number;
  // Build-time semantic expansion: synonyms / alternate phrasings / related
  // keywords for this skill, generated by an LLM at federation time (see
  // scripts/enrich-catalog.mjs) and matched by the shared retrieval engine. Lets
  // a query ("crawl a site") hit a skill described differently ("web scraping")
